...
\newtheorem{definition}{\indent\hei\color{black}定义}[chapter]
\newtheorem{proposition}{\indent\color{darkblue}命题}[chapter]
\newtheorem{theorem}{\indent\color{black}定理}[chapter]
...
%==========定义框====================================
\newcommand{\definibox}[2]{
\definition{\hei\color{black}(#1)}\quad \color{black}#2
}
%==========定义框结束====================================
